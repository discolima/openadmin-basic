...
<div id="tabs-1">
	...
	<input type="text" name="emisor[rfc]" id="rfc" class="text ui-widget-content ui-corner-all" value="<?=(isset($row['emisor']['rfc']))?$row['emisor']['rfc']:''?>" onkeyup="javascript:this.value=this.value.toUpperCase();" required/>
	<label for="nombre">Razon social</label>
	<input type="text" name="emisor[nombre]" id="nombre" class="text ui-widget-content ui-corner-all" value="<?=(isset($row['emisor']['nombre']))?$row['emisor']['nombre']:''?>" onkeyup="javascript:this.value=this.value.toUpperCase();" required/>
	<label for="RegimenFiscal">Regimen fiscal</label>
	<input type="text" name="emisor[RegimenFiscal]" id="RegimenFiscal" class="text ui-widget-content ui-corner-all" value="<?=(isset($row['emisor']['RegimenFiscal']))?$row['emisor']['RegimenFiscal']:''?>" onkeyup="javascript:this.value=this.value.toUpperCase();" required/>
</div>
...
<div id="tabs-4">
	...
	<input type="text" name="PAC[usuario]" id="usuario" class="text ui-widget-content ui-corner-all" value="<?=(isset($row['PAC']['usuario']))?$row['PAC']['usuario']:''?>" readonly/>
	<label for="pass">Password</label>
	<input type="text" name="PAC[pass]" id="pass" class="text ui-widget-content ui-corner-all" value="<?=(isset($row['PAC']['pass']))?$row['PAC']['pass']:''?>" readonly/>
...
<div id="tabs-5">
	...
	<input type="text" name="PAC[cer]" id="cer" class="text ui-widget-content ui-corner-all" value="<?=(isset($row['PAC']['cer']))?$row['PAC']['cer']:''?>" readonly/>
	<label for="key">Key</label>
	<input type="text" name="PAC[key]" id="key" class="text ui-widget-content ui-corner-all" value="<?=(isset($row['PAC']['key']))?$row['PAC']['key']:''?>" readonly/>
	<label for="pass">Password</label>
	<input type="text" name="PAC[SAT][pass]" id="pass" class="text ui-widget-content ui-corner-all" value="<?=(isset($row['PAC']['SAT']['pass']))?$row['PAC']['SAT']['pass']:''?>" readonly/>
</div>
</div>
</form>
